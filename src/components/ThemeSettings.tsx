                  ...
                  {recentThemes.map((themeId) => {
                    ...
                    return (
                      <Button
                        key={themeId}
                        variant={
                          currentTheme === themeId ? "default" : "outline"
                        }
                        size="sm"
          ...
          <TabsContent value="create" className="space-y-4">
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Used for highlights, secondary actions, and decorative
                  elements
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  This preview shows how your theme will look. Dark/light base
                  themes will still affect many other colors automatically.
                </p>
              </div>
            </div>
          </TabsContent>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {customThemes
                    .filter(
                      (theme) => !["system", "light", "dark"].includes(theme.id)
                    )
                    .map((theme) => (
                      <Card
                        key={theme.id}
                  ...
                  {customThemes.filter(
                    ...
                    <p className="text-sm text-muted-foreground italic">
                      No custom themes created yet. Create one in the "Create
                      New" tab.
                    </p>
                  )}
                </div>
